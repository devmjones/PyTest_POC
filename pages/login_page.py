...
from .base_page import BasePage # Like a dir with relative path - within the same dir use .
...
class LoginPage(BasePage):
    ...
    def __init__(self, driver): # constructor. Code will run each time a new instance of the LoginPage class is created
        super().__init__(driver) # calls method on parent class
        self.driver = driver
        self._visit("/login")
